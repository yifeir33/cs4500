...
void test4() {
    ...
    GT_EQUALS(r0.get_bool(3), (bool)1);
    ...
    GT_EQUALS(r1.get_bool(4), (bool)0);
    GT_EQUALS(r1.get_bool(5), (bool)1);
    ...
    GT_EQUALS(r1.col_type(0), 'S');
    GT_EQUALS(r1.col_type(1), 'I');
    GT_EQUALS(r1.col_type(2), 'F');
    GT_EQUALS(r1.col_type(3), 'F');
    GT_EQUALS(r1.col_type(4), 'B');
    GT_EQUALS(r1.col_type(5), 'B');
...
TEST(a4p1, t4){ ASSERT_EXIT_ZERO(test4); }
